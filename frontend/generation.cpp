...
{
    // Check network reply
    if (handleCommonRequestError(worker, "trying to list data directory"))
    {
...
{
    // Check network reply
    if (handleCommonRequestError(worker, "trying to generate journals for directory"))
        return;
...
{
    // Check network reply
    if (handleCommonRequestError(worker, "trying to stop run data scan for directory"))
        return;
}
