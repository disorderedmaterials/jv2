...
Source: "{#BackendDir}\jv2Setup.exe"; DestDir: "{app}\bin\jv2Setup"; Flags: ignoreversion
Source: "{#BackendDir}\isisInternal.exe"; DestDir: "{app}\bin\jv2Setup\isisInternal"; Flags: ignoreversion
