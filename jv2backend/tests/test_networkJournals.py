...
from jv2backend.classes.requestData import RequestData
...
def _get_library_index(library: jv2backend.main.library.JournalLibrary) -> str:
...
def test_parse_isis_journal_index(app):
    library = jv2backend.main.library.JournalLibrary({})
