...
from backend.jv2.app import create_app
from backend.jv2.classes.requestData import RequestData
...
def _get_library_index(library: backend.jv2.main.library.JournalLibrary) -> str:
...
def test_parse_isis_journal_index(app):
    library = backend.jv2.main.library.JournalLibrary({})
